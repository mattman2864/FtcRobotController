...
public class SpecimanAuto extends OpMode {
    ...
    private final double distanceToClip = 15.0;

    private final Pose lineupPose1 = new Pose(14.6, 16.4, Math.toRadians(0));
    ...
    private final Pose groundPickupPose1 = new Pose(22.87, -39.90, Math.toRadians(0));
    ...
    public void buildPaths() {
        ...
        retrieveFirstSpecimen = follower.pathBuilder()
                ...
                .setLinearHeadingInterpolation(dropoffPose3.getHeading(), specimanPickupPose.getHeading())
                .build();
        ...
        clip1 = follower.pathBuilder()
                ...
                .setLinearHeadingInterpolation(specimanPickupPose.getHeading(), clippingPose2.getHeading())
                .build();
        ...
        retrieveSecondSpecimen = follower.pathBuilder()
                ...
                .addPath(new BezierLine(new Point(specimanPickupLineupPose), new Point(specimanPickupPose)))
                .setLinearHeadingInterpolation(clippingPose2.getHeading(), specimanPickupPose.getHeading())
                .build();
        ...
        clip2 = follower.pathBuilder()
                ...
                .setLinearHeadingInterpolation(specimanPickupPose.getHeading(), clippingPose3.getHeading())
                .build();
        ...
        retrieveThirdSpecimen = follower.pathBuilder()
                ...
                .addPath(new BezierLine(new Point(specimanPickupLineupPose), new Point(specimanPickupPose)))
                .setLinearHeadingInterpolation(clippingPose3.getHeading(), specimanPickupPose.getHeading())
                .build();
        ...
        clip3 = follower.pathBuilder()
                ...
                .setLinearHeadingInterpolation(specimanPickupPose.getHeading(), clippingPose4.getHeading())
                .build();
    }
    ...
    public void liftStateUpdate() {
        switch (liftState) {
            ...
            case 1:
                ...
                if (liftTimer.getElapsedTime() > 6000)
                {
