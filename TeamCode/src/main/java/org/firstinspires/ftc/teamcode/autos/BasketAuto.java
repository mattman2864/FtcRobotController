...
public class BasketAuto extends OpMode {
    ...
    private final Pose backupLift = new Pose(10, 20, Math.toRadians(180));
    private final Pose outtake = new Pose(6.5, 20.5, Math.toRadians(-42));
    private final Pose firstPickup = new Pose(23, 15, Math.toRadians(180));
    private final Pose secondPickup = new Pose(23, 25, Math.toRadians(180));
    private final Pose parkLineup = new Pose(49, 29, Math.toRadians(-90));
    private final Pose pushBlock = new Pose(2, 29, -90);
    private final Pose parkOnBar = new Pose(49, -1, Math.toRadians(-90));
